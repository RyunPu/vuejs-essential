...
export default {
  ...
  data() {
    return {
      ...
      resources: [
        ...
        {
          title: 'Vue Resource Github 文档',
          link: 'https://github.com/pagekit/vue-resource/tree/develop/docs',
        },
      ]
    }
  },
  ...
  created() {
    ...
    this.$http.post('/articles/hot', { num: 10 }).then((res) => {
      this.hotArticles = res.body
    })
  }
}
</script>
