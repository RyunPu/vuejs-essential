    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-5 col-lg-5">
          ...
          <div class="text-md">
            <a v-for="item in contacts" :href="item.link" :title="item.title" :style="contactStyle" target="_blank">
              ...
              <ul class="list-unstyled">
                <li v-for="item in sponsor.list">
                  <a :href="item.link" target="_blank">
                    <img :src="item.logo" :title="item.title" class="footer-sponsor-link" width="98">
                  </a>
                </li>
              </ul>
            </div>
